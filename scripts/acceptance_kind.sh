...
PLATFORM_CASES=("backstage" "observability" "opentelemetry" "fluentbit-native" "fluentbit-helm" "fluentbit-operator" "vault" "keycloak" "ceph" "longhorn" "openbao" "apisix" "superset" "powerbi" "cert-manager" "external-dns" "gateway-api" "network-policies")
INTEGRATION_CASES=("dataprepper-opensearch" "keycloak-postgresql" "persistence-longhorn" "persistence-ceph" "webapp-postgresql-stack" "webapp-kafka-stack" "webapp-rabbitmq-stack" "webapp-redis-stack" "webapp-mongodb-stack" "apisix-superset-questdb-stack" "powerbi-questdb-superset-stack" "questdb-superset-stack")
...
Options:
  --case <name>        Run one case/group. Supported groups: basic, search,
                       ...
                       helmfile-integration, apisix, superset, powerbi,
                       apisix-superset-questdb-stack,
                       powerbi-questdb-superset-stack,
                       questdb-superset-stack, crossplane-lifecycle,
